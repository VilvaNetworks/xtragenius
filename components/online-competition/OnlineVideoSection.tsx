...
export default function OnlineVideoSection() {
    ...
    <section className="bg-[#fcfcfc] py-24 relative overflow-hidden">
      <div className="mx-auto max-w-[1200px] px-4">
        <div className="flex flex-col md:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="relative flex-1 w-full max-w-[850px] mx-auto md:ml-12">
            ...
            <AnimateOnScroll delay={0}>
              <div
                className="relative z-10 w-full aspect-[6/4] rounded-sm  overflow-hidden group bg-white cursor-pointer"
                onClick={() => setIsPlaying(true)}
              >
                {!isPlaying ? (
                  <>
                    <Image
                      src="/images/online-competition/img4.png"
          ...
          <div className="flex-1 w-full relative z-10 pt-10 md:pt-0">
            {/* Decorative ring */}
            <div className="absolute -top-4 -left-6 w-10 h-10 border-[3px] border-orange-200 rounded-full opacity-60"></div>

            <AnimateOnScroll delay={300}>
              <h2 className="text-[36px] font-bold text-[#3F3A64] mb-8 relative z-10">
            ...
            <div className="flex flex-col gap-8 border-l-2 border-gray-100 pl-6 ml-2">
              {highlights.map((highlight, index) => (
                <AnimateOnScroll delay={400 + index * 100} key={index}>
                  <div className="relative">
                    {/* Bullet point on the line */}
                    <div className="absolute -left-[31px] top-1.5 w-3 h-3 bg-[#ff6600] rounded-full shadow-[0_0_0_4px_#fcfcfc]"></div>
